data merge block ~ ~ ~ {Items:[{Slot:4b,id:"minecraft:leather_helmet",Count:1b,tag:{display:{Name:'{"text":"Baker\'s Hat","color":"aqua","bold":true,"italic":false}'},CustomModelData:254111,helm.baker:1b,helm:1b}}]}
